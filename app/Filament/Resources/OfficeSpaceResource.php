    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('is_full_booked')->boolean()->trueColor('danger')->falseColor('success')->trueIcon('heroicon-o-check-circle')->falseIcon('heroicon-o-x-circle')->label('Sudah bayar?'),
            ])
            ->filters([
